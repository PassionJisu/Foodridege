...
- **기관**: 점심 이후 미배식 잔반 수거 신청. **오전 11시~오후 3시**만 접수(데모용 On/Off로 강제 열기 가능). 신청 즉시 전역 번호·대학 자판기가 라운드로빈으로 배정
...
전역 번호 **1~120**을 신청 순서대로 부여하고, 전남대·광주여대·남부대·광주대·호남대·조선대 자판기에 **라운드로빈**으로 넣어 특정 학교에 반찬이 몰리지 않게 합니다. 기사 입고 화면은 새 번호를 만들지 않고, 신청 때 받은 번호 그대로 넣습니다.
