...
- **청년**: 환승반찬·MealPick은 대학생과 같음. **친구카세는 대학생 전용**이라 탭을 누르면 「대학생만 이용 가능합니다.」 팝업만 표시. 홈·마이페이지에서는 친구카세 이용 횟수·무료 식권·식권 예약 내역을 보여 주지 않음
...
6. 회원가입에서 대학생·청년·점주 폼은 한국어/영어 병기. 외국인 대학생은 학번, 외국인 청년은 ARC
7. 회원가입에서 대학생 → 외국인(교환학생) → 체류 종료일을 어제 이전으로 두면, 다시 로그인할 때 자동 탈퇴 메시지를 확인할 수 있습니다
